...
public class MyIndexWriter {
  ...
  /**
   * This method build index for each document. NOTE THAT: in your implementation of the index, you
   * should transform your string docnos into non-negative integer docids !!! In MyIndexReader, you
   * should be able to request the integer docid for docnos.
   *
   * @param docno
   * @param content
   * @throws IOException
