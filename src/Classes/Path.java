...
public class Path {
  ...
  public static String ResultHM1 = "data//result.";// address of results.*
  ...
  public static String ResultWebDir = "data//result.trecweb";// address of result.trectext
  public static String ResultTextDir = "data//result.trectext";// address of result.trectext
